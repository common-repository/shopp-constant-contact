<?php
/*
Plugin Name: Shopp + Constant Contact
Description: Customers who opt-in to email marketing from your WordPress ecommerce site during checkout are added to a specified list on Constant Contact.
Version: 1.3
...
Shopp_ConstantContact::smartLoad();

class Shopp_ConstantContact {
	...
	public static function smartLoad() {
		$instantiate = apply_filters('shoppConstantContactLoadBasic', true);
		if ($instantiate) { new Shopp_ConstantContact; }
	}

	public function __construct() {
		add_action('admin_init', array($this, 'admin_css'));
		add_action('admin_menu', array($this, 'admin_menu'));
		add_action('shopp_order_success', array($this, 'add_to_constant_contact_list'));
		
		$this->username = get_option('shopp_constant_contact_username');
		$this->password = get_option('shopp_constant_contact_password');
		$this->api_key = get_option('shopp_constant_contact_api_key');
		$this->list_id = get_option('shopp_constant_contact_list_id');
	}

	public function admin_css() {
		wp_register_style( 'shopp-constant-contact-stylesheet', plugins_url( 'css/shopp-constant-contact.css', __FILE__ ), array(), '20140823' );
		wp_enqueue_style( 'shopp-constant-contact-stylesheet' );
	}
	...
	public function admin_menu() {
		...
		$page = add_submenu_page('shopp-101-extensions', 'Constant Contact', 'Constant Contact', 'shopp_menu', 'shopp-constant-contact', array($this, 'render_display_settings'));
        add_action( 'admin_print_styles-' . $page, 'admin_styles' );
		...
		<div class="metabox-holder">	
			...
			<div id="shopp-extensions-about-the-author" class="postbox">
				...
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
                            <td width="70%"><div><img style="padding: 0px 15px 0px 0px; float:left" src="<?php echo plugins_url( 'shopp-constant-contact/images/lorenzo-orlando-caum-shopp-wordpress-150x150.jpg' , dirname(__FILE__) ); ?>" border="0" alt="Founder of Enzo12 LLC" width="150" height="150">
...
<?php	 	 
	...
	public function add_to_constant_contact_list($Purchase) {
		global $wpdb;
		
		$marketing = $wpdb->get_var("SELECT marketing FROM ".$wpdb->prefix."shopp_customer WHERE id = '".	$Purchase->customer."'");
		
		if ($marketing == "yes") {			
			$constant_contact_api = new constant_contact($this->username, $this->password, $this->api_key);
			...
			$constant_contact_api->add_contact($constant_contact_user, array($this->list_id));
		}
	}

	public function render_display_settings() {
		wp_nonce_field('shopp-constant-contact');
		...
		if(!empty($_POST['submit'])){
			...
			update_option("shopp_constant_contact_username", $this->username);
			update_option("shopp_constant_contact_password", $this->password);
			update_option("shopp_constant_contact_api_key", $this->api_key);
			update_option("shopp_constant_contact_list_id", $this->list_id);
		}
?>

<div class="wrap">
	<h2>Shopp + Constant Contact</h2>
	<div class="postbox-container" style="width:65%;">
		<div class="metabox-holder">	

			<div id="shopp-constant-contact-introduction" class="postbox">
				<h3 class="hndle"><span>Introduction</span></h3>
				<div class="inside">
					<p>This plugin integrates <a href="http://shopp101.com/go/shopp/" title="Learn more about Shopp">Shopp</a> with <a href="http://shopp101.com/go/constantcontact/" title="Learn more about Constant Contact">Constant Contact</a> and is part of the Shopp 101 extensions.</p> 
					<p>During checkout, a customer has the option to opt-in to email marketing. If they choose to do so, then they will be added to a specified email list on Constant Contact.</p>
					...
					<p>Credit to Envoy Media Group who created the PHP API Wrapper for the Constant Contact API. <a href="http://www.envoymediagroup.com/Code/CTCT-Web-Services-PHP-Library.html" title="Learn about the PHP API Wrapper for Constant Contact">Learn more about the Constant Contact API</a></p>
				</div>
			</div>

			<div id="shopp-constant-contact-general-settings" class="postbox">
				<h3 class="hndle"><span>Setup Tutorial</span></h3>
				<div class="inside">
				<p><strong>How to Find Your Information from Constant Contact</strong><br /><br /><iframe src="http://player.vimeo.com/video/31883279?title=0&amp;byline=0&amp;portrait=0" width="600" height="300" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></p>
                <p>Pro-tip: After starting a video, click on the fullscreen button which appears to the right of the HD toggle.</p>
				</div>
			</div>
			
			<div id="shopp-constant-contact-support-feedback" class="postbox">
				<h3 class="hndle"><span>Support & Feedback</span></h3>
				<div class="inside">
				...
				<p>This plugin is <strong>actively supported</strong>. Support is provided as a courtesy by Lorenzo Orlando Caum, Enzo12 LLC. If you have any questions or concerns, please open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Shopp 101">new support ticket</a> via our help desk.</p>
                    <p>You can share feedback via this a <a href="http://shopp101.com/go/shopp-extensions-survey/" title="Take a super short survey">short survey</a>. Takes just a few minutes &mdash; we promise!</p>
                    <p>Feeling generous? You can support the continued development of the Shopp + Constant Contact by <a href="http://shopp101.com/go/donate-shopp-constant-contact/" title="Say thank you by purchasing Lorenzo a Redbull">buying me a Redbull</a>, <a href="http://shopp101.com/go/amazonwishlist/" title="Say thank you by gifting Lorenzo a book">ordering me a book</a> from my Amazon wishlist, or <a href="http://shopp101.com/go/tip-shopp-help-desk/" title="Say thank you by tipping Lorenzo via the Shopp Help Desk">tipping me</a> through the Shopp help desk.</p>
				</div>
			</div>
			
			<div id="shopp-constant-contact-settings" class="postbox">
				<h3 class="hndle"><span>Constant Contact Settings</span></h3>
				<div class="inside">
                    <p>The Constant Contact API Key is <strong>no longer included</strong>. You will need to register for your own API Key with Constant Contact: <a href="http://developer.constantcontact.com" title="Register for Constant Contact API">http://developer.constantcontact.com</a>
                    </p>
                    <p>
			...
			<div id="shopp-constant-contact-about-the-author" class="postbox">
				<h3 class="hndle"><span>About the Author</span></h3>
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
	...
	<div class="postbox-container" style="width:25%;">
		<div class="metabox-holder">
			...
			<div id="shopp-constant-contact-donate" class="postbox">
				<h3 class="hndle"><span><strong>Make a Donation!</strong></span></h3>
				<div class="inside">
					<p>Hi friend!</p>
					<p>If this plugin is helpful to you, then please <a href="http://shopp101.com/go/donate-shopp-constant-contact/" title="Say thank you by purchasing Lorenzo a Redbull">buy me a Redbull</a>.</p> 
					...
					<p>Your kindness is appreciated and will go towards <em>continued development</em> of the Shopp + Constant Contact plugin.</p>
				</div>
			</div>
			
			<div id="shopp-constant-contact-subscribe" class="postbox">
			...
			<div id="shopp-constant-contact-have-a-question" class="postbox">
				<h3 class="hndle"><span>Have a Question?</span></h3>
				<div class="inside">
                    <p>Open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Shopp 101">new support ticket</a> for Shopp + Constant Contact</p>
			...
			<div id="shopp-constant-contact-news-from-oms" class="postbox">
				<h3 class="hndle"><span>News from Shopp 101</span></h3>
				<div class="inside">
				<p>Free Report<br /> <a href="http://shopp101.com/newsletter/" title="Receive your free report delivered instantly to your inbox">10 Steps to a More Secure WordPress</a></p>
				<p>Documents & Presentations<br /> <a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on creating a fast Shopp website">Speeding up your Shopp Ecommerce Website</a><br /><a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on using Shopp with caching plugins">Shopp + Caching Plugins</a></p>
			...
			<div id="shopp-constant-contact-recommendations" class="postbox">
